...
const AdvancedCharts = () => {
  return (
    <Section>
      <CategoryHeader text="CRYPTO" animation="slide-left" duration="1000" />
      ...
      <CategoryHeader text="FOREX" animation="slide-left" duration="1000" />
      ...
      <CategoryHeader text="STOCK" animation="slide-left" duration="1000" />
      ...
      <CategoryHeader text="FUTURES" animation="slide-left" duration="1000" />
